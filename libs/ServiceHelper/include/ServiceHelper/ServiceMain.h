...
template <class TApp>
struct ServiceMain {
  ServiceMain(LPTSTR serviceName, LPCTSTR displayName, LPTSTR description, TCHAR* argv[]) {
    ...
    SERVICE_TABLE_ENTRY DispatchTable[] = { { serviceName, static_cast<LPSERVICE_MAIN_FUNCTION>(serviceMain) },
                                            { NULL, NULL } };
